...
5. **Sync the index** - Add a one-line entry in the matching README category
   ...
   (`![spec](docs/media/spec-badge.svg)`) and bump the
...
- [Core coding](#core-coding) (12) ![spec](docs/media/spec-badge.svg)
- [System design](#system-design) (5) ![spec](docs/media/spec-badge.svg)
- [Git & GitHub](#git--github) (11) ![spec](docs/media/spec-badge.svg)
- [Code review & quality](#code-review--quality) (3)
- [Testing & quality](#testing--quality) (9) ![spec](docs/media/spec-badge.svg)
- [Docs & delivery](#docs--delivery) (5)
- [Security & performance](#security--performance) (7) ![spec](docs/media/spec-badge.svg)
- [DevOps & deploy](#devops--deploy) (9)
- [Career & learning](#career--learning) (6)
- [Frontend & UI](#frontend--ui) (9) ![spec](docs/media/spec-badge.svg)
- [Data & AI](#data--ai) (7) ![spec](docs/media/spec-badge.svg)
- [Mobile development](#mobile-development) (2) ![spec](docs/media/spec-badge.svg)
...
- [codebase-onboarding-prompt.md](core-coding/codebase-onboarding-prompt.md) ![spec](docs/media/spec-badge.svg) - understand an unfamiliar repo at verification depth: stack, architecture, data flow, conventions, gotchas, with file:line evidence.
...
- [code-migration-prompt.md](core-coding/code-migration-prompt.md) ![spec](docs/media/spec-badge.svg) - migrate code between frameworks/languages with behavior parity and incremental verification.
...
- [system-design-prompt.md](system-design/system-design-prompt.md) ![spec](docs/media/spec-badge.svg) - design a scalable system end-to-end: requirements, components, tradeoffs, failure modes, phased build.
...
- [ci-cd-workflow-prompt.md](git-github/ci-cd-workflow-prompt.md) ![spec](docs/media/spec-badge.svg) - build a verified, secure GitHub Actions pipeline.
...
- [good-first-issue-workflow-prompt.md](git-github/good-first-issue-workflow-prompt.md) ![spec](docs/media/spec-badge.svg) - GitHub Actions workflow reserving starter issues for first-time contributors.
...
- [bug-finder-prompt.md](testing-quality/bug-finder-prompt.md) ![spec](docs/media/spec-badge.svg) - sweep a codebase across correctness factors and get a clear, evidence-backed, priority-ordered list of bugs.
- [bug-finder-with-docs-prompt.md](testing-quality/bug-finder-with-docs-prompt.md) ![spec](docs/media/spec-badge.svg) - find bugs and leave a durable bug ledger behind: a priority-ordered report plus BUGS.md and README pointers, with the code untouched.
...
- [security-audit-prompt.md](security-performance/security-audit-prompt.md) ![spec](docs/media/spec-badge.svg) - full-repo audit: injection, auth, secrets, dependencies, with verified findings.
...
- [ui-audit-prompt.md](frontend-ui/ui-audit-prompt.md) ![spec](docs/media/spec-badge.svg) - audit UI for visual consistency, design system adherence, spacing, typography, and responsive behavior with concrete fixes and file:line evidence.
...
- [mobile-app-develop-prompt.md](mobile-dev/mobile-app-develop-prompt.md) ![spec](docs/media/spec-badge.svg) - build a mobile feature and prove it works on both platforms: offline, permissions, deep links, lifecycle, with a platform verification matrix.
...
- [ai-agent-build-prompt.md](data-ai/ai-agent-build-prompt.md) ![spec](docs/media/spec-badge.svg) - design and build an LLM agent: tool contracts, context strategy, guardrails, eval set, cost and latency budget.
